...
<html lang=it dir="ltr">
  <head>
    ...
    <meta name=“author” content=“FrancescoLazzarotto“ />
...
<div class="parallax-container">
      ...
      <center>
        <table id="benefit">
          <tr>
            ...
            <td> <img src="assets/immagini/l1.png" class="benefits" alt="logo benefici" title="logo" > </td>
            ...
            <td> Otterrai una scheda personale per tracciare i tuoi progressi! <br>
             ...
             <td><img src="assets/immagini/l2.png" class="benefits" alt="logo benefici" title="logo"></td>
             <td> Avrai sempre un istruttore pronto ad aiutarti e a risolvere i tuoi problemi! </td>

           </tr>
        <tr>

            <td><img src="assets/immagini/l3.png" class="benefits" alt="logo benefici" title="logo"></td>
            <td> Sconti dedicati a tutte le fascie d'età, la palestra è per tutti! </td>
            <td><img src="assets/immagini/l4.png" class="benefits" alt="logo benefici" title="logo"></td>
 ...
 <div class="maps">
   ...
   <center>
      ...
      <table class="tabellaarea"> <tr> <td> <img src="assets/immagini/cardio.jpg" class="area" alt="Cardio tapis roulante" title="area cardio" style=" border-radius: 15px; 
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);"> </td>
              <td>
          ...
          <tr>
             <td>
              ...
              <td>
                ...
                <img src="assets/immagini/pesi.jpg" class="area" alt="Cardio tapis roulante" title="area cardio" style=" border-radius: 15px; 
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);">
           ...
           <tr>
             <td>
               ...
               <img src="assets/immagini/iso2.jpg" class="area" alt="Cardio tapis roulante" title="area cardio" style=" border-radius: 15px; 
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);">
            ...
            <td>
              ...
              <img src="assets/immagini/funz.jpg" class="area" alt="Cardio tapis roulante" title="area cardio" style=" border-radius: 15px;
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);">
              ...
              --> <div style="width: 100%"><iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Via%20Silvio%20Pellico%2012%20+(Iframe%20maps%20sito)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps trackers</a></iframe></div> </div>
</div>
