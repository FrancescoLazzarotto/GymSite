...
//se ci sono risultati estrae i dati del corso e li mette in $corsi
    if (mysqli_num_rows($risultato) > 0) {
        $corsi = mysqli_fetch_assoc($risultato); 
...
<div id="content2"> 
    ...
    if (isset($corsi)) {
        ...
        // Aggiungi ulteriori dettagli del corso se necessario.

    } 
    ?> </ul> 
    
     <a href="eliminazione.php" class="lb"> 
      <button type="submit" class="backcorsi">Torna all'eliminazione dei corsi</button>
  </a>
