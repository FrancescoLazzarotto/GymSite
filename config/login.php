...
if (is_array($userData)) { // Se i dati sono un array, l'utente è stato trovato
    ...
    $_SESSION["password"] = $password; // Salva la password in chiaro solo se necessario, ma non è consigliato per sicurezza
    ...
    if ($userData['amministratore'] == 1) {
        ...
        header("Location: homee.php"); // Se non è amministratore, rimanda alla home
